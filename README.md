## One Home`s YiiMP Server Installer !

## This is opened as a public repo - all features are not final!

All in one installer for your yiimp server.

**One Home YiiMP Server Installer! ** Automates most of the tedious tasks of the following releases:
...
* [DirtyHarry](https://github.com/DirtyHarryDev)
